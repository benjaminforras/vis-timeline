...
class Core {
    ...
    fastdom.mutate(() => {
      ...
      if (options.verticalScroll) {
        if (options.rtl) {
          ...
          props.left.width =
            leftContainerClientWidth + props.scrollbarWidth ||
            -props.border.left;
  ...
  _setDOM() {
    ...
    fastdom.mutate(() => {
      ...
      const centerWidth =
        props.root.width - props.left.width - props.right.width;
      ...
      dom.backgroundVertical.style.left = `${props.left.width + props.border.left
        }px`;
      ...
      dom.rightContainer.style.left = `${props.left.width + props.center.width
        }px`;
      dom.rightContainer.style.top = `${props.top.height}px`;
      dom.top.style.left = `${props.left.width}px`;
      dom.top.style.top = "0";
      dom.bottom.style.left = `${props.left.width}px`;
      dom.bottom.style.top = `${props.top.height + props.centerContainer.height
        }px`;
